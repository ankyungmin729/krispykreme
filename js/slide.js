//슬라이드
const $indicators = document.querySelectorAll('.mainBanner>.slide > .slidePagination > li > a');
const $container = document.querySelector('.mainBanner>.slide>.slideContainer');
const $btnPrev = document.querySelector('.mainBanner>.slide > a.prev');
const $btnNext = document.querySelector('.mainBanner>.slide > a.next');

const $btnAuto = document.querySelector('.mainBanner>.slide > .btn_auto'); //자동재생 버튼
